                  ...
                  <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-gray-700 focus-within:border-transparent transition-all bg-white">
                    ...
                    <div className="flex-1 relative flex items-center">
                      ...
                      <input
                        ...
                        className="w-full h-full py-3 pl-12 pr-4 text-sm border-none focus:outline-none focus:ring-0 bg-transparent placeholder:text-gray-400"
          ...
          <form onSubmit={handleSearch} className="ec-header__search-form space-y-2">
            ...
            <div className="relative border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-gray-700 focus-within:border-transparent bg-white flex items-center">
              ...
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
                placeholder="商品を検索"
                className="flex-1 pl-11 pr-2 py-2.5 text-sm border-none focus:outline-none focus:ring-0 bg-transparent placeholder:text-gray-400"
                style={{ outline: 'none', boxShadow: 'none' }}
              />
