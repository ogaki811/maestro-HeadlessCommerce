          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between py-4 gap-4">
              ...
              <div className="ec-header__actions flex items-center space-x-4">
                {/* 見積り依頼（開発中は常に表示） */}
                <Link href="/quotations" className="flex flex-col items-center p-2 text-gray-600 hover:text-gray-700 transition-colors">
                  ...
                  <span className="text-xs mt-1">見積り依頼</span>
                </Link>
