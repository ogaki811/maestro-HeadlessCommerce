...
export const companyFolders: CatalogFolder[] = [
  { id: 'company-1', name: '保存水', type: 'company', displayOrder: 1, itemCount: 8 },
...
export const sampleCatalogItems: CatalogItem[] = [
  ...
  },
  {
    ...
    partNumber: '136',
    imageUrl: '/img/product/A0188601.jpg',
    standardPrice: 1980,
    salePrice: 1790,
    memo: 'A002',
    orderComment: '',
  ...
  },
  {
    ...
    brandName: '伊藤園',
    partNumber: '',
    imageUrl: '/img/product/A0173711.jpg',
    standardPrice: 2580,
    salePrice: 1207,
    memo: 'A021',
    orderComment: '',
  ...
  },
  {
    ...
    brandName: '秩父源流水',
    partNumber: '',
    imageUrl: '/img/product/A7740251.jpg',
    standardPrice: 2160,
    salePrice: 1670,
    memo: 'A100',
    orderComment: '',
  ...
  },
  {
    id: 'item-5',
    folderId: 'company-1',
    productId: 'prod-213615',
    productCode: '213615',
    productName: 'コピー用紙 A4 500枚×5冊',
    brandName: 'コクヨ',
    partNumber: 'KB-39N',
    imageUrl: '/img/product/A2136151.jpg',
    standardPrice: 2980,
    salePrice: 2480,
    memo: 'A102',
    orderComment: '',
  ...
  },
  {
    id: 'item-6',
    folderId: 'company-1',
    productId: 'prod-778600',
    productCode: '778600',
    productName: 'ボールペン 黒 0.5mm 10本入',
    brandName: 'パイロット',
    partNumber: 'BK-100',
    imageUrl: '/img/product/A7786001.jpg',
    standardPrice: 1200,
    salePrice: 980,
    memo: 'B001',
    orderComment: '',
  ...
  },
  {
    id: 'item-7',
    folderId: 'company-1',
    productId: 'prod-868111',
    productCode: '868111',
    productName: 'クリアファイル A4 100枚入',
    brandName: 'キングジム',
    partNumber: 'CF-100',
    imageUrl: '/img/product/A8681111.jpg',
    standardPrice: 1500,
    salePrice: 1280,
    memo: 'B010',
    orderComment: '',
  ...
  },
  {
    id: 'item-8',
    folderId: 'company-1',
    productId: 'prod-022481',
    productCode: '022481',
    productName: 'ふせん 75×75mm 5色セット',
    brandName: '3M',
    partNumber: 'POST-IT-75',
    imageUrl: '/img/product/A0224811.jpg',
    standardPrice: 680,
    salePrice: 550,
    memo: 'B020',
    orderComment: '',
